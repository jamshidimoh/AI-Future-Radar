...
def test_deterministic_recovery_supports_the_actually_due_lesson(monkeypatch):
    lesson = {
        ...
        "a": {
            ...
            "fa": "مهندسی هارنس عامل",
            "seed": "طراحی محیط، ابزارها، محدودیت‌ها، آزمون‌ها و بازخوردهایی که یک agent در آن‌ها کار می‌کند تا رفتار آن قابل کنترل‌تر و قابل ارزیابی‌تر شود.",
        },
        "b": {
            "term": "Agent Harness",
            "fa": "هارنس عامل",
            "seed": "لایه اجرایی پیرامون یک AI agent که context، ابزار، مجوزها، مشاهده نتایج و کنترل اجرای آن را مدیریت می‌کند.",
        },
