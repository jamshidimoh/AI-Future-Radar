...
def test_top_technical_candidate_only():
    items=[{"title":"MCP protocol for AI agents","summary":"Model Context Protocol architecture and runtime","source_type":"technical","source_tier":1,"category":"ai","published":"2026-09-15 10:00"},{"title":"General AI news","summary":"A new model was released","source_type":"news","source_tier":1,"category":"ai"}]
