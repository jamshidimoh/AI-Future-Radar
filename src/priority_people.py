...
def priority_people_features(item):
    ...
    # The publication boundary must use the same Tier-0 classification as ranking:
    # protected leader stories explicitly marked by the ranking contract are
    # Tier-0 even when they are leader activity rather than interview content.
