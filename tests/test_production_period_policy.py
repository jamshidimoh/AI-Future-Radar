...
def test_tier0_interviews_are_global_first_but_do_not_consume_normal_rank_window():
    items = [
        {"id": "normal1", "editorial_score": 95, "title": "خبر", "summary": "متن فارسی", "why_it_matters": "اهمیت", "content_type": "news"},
        {"id": "person1", "editorial_score": 50, "title": "Sam Altman interview", "content_type": "interview", "leader": "Sam Altman", "protected_slot": True, "summary": "یک گفتگوی طولانی درباره مدل‌ها، ایجنت‌ها، ایمنی و آینده هوش مصنوعی با جزئیات کافی.", "why_it_matters": "اهمیت"},
        {"id": "person2", "editorial_score": 49, "title": "Elon Musk interview", "content_type": "interview", "leader": "Elon Musk", "protected_slot": True, "summary": "یک گفتگوی طولانی درباره مدل‌ها، زیرساخت، عامل‌های هوشمند و آینده هوش مصنوعی با جزئیات کافی.", "why_it_matters": "اهمیت"},
        {"id": "normal2", "editorial_score": 90, "title": "خبر دوم", "summary": "متن فارسی", "why_it_matters": "اهمیت", "content_type": "research"},
    ]
    ranked = _global_ranked_selection(items, 4, 2, 2, {})
    assert ranked[0]["id"] == "person1"
    assert ranked[1]["id"] == "person2"
    tier0 = [x for x in ranked if x.get("tier0_rank") is not None]
    assert [x["id"] for x in tier0] == ["person1", "person2"]
