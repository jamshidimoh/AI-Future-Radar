...
from src.llm_router_light import _select_hf_model, call_llm_with_fallback, get_quality_chain
...
class HuggingFaceLightRouterTests(unittest.TestCase):
    ...
    def test_free_first_selects_free_model_when_no_explicit_model(self):
        ...
        with patch.dict(os.environ, {"HF_POLICY": "free-first", "HF_MODEL": ""}, clear=False), patch("src.llm_router_light._discover_hf_models", return_value=models):
            self.assertEqual(_select_hf_model(), "qwen/free-model")
