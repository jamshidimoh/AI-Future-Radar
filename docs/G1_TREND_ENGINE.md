...
Tests cover repeatability, bounded similarity, anti-chain clustering, weak-signal retention, source independence, Source Tier independence, non-destructive enrichment, and fail-closed configuration validation.
