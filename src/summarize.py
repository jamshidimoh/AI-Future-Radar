...
{depth}
قواعد سخت ویرایشی: خروجی باید «بازنویسی طبیعی برای یک رسانه فارسی‌زبان» باشد، نه ترجمه تحت‌اللفظی یا ترجمه واژه‌به‌واژه. ترتیب و ساختار جمله‌های زبان مبدأ را تقلید نکن؛ جمله‌های سنگین انگلیسی را به فارسی روان، دقیق و طبیعی تبدیل کن و فعل را تا حد امکان در جای طبیعی فارسی قرار بده. از عبارت‌های ترجمه‌ای و ماشینی مانند «این موضوع در حال حاضر»، «در یک حرکت»، «برای انجام این کار»، «گزارش می‌کند که» و ترکیب‌های نامأنوس پرهیز کن. نام رسمی افراد، شرکت‌ها، محصولات، مدل‌ها و پروژه‌ها Latin بماند و آوانویسی فارسی نام خاص ممنوع است؛ اصطلاحات فنی رایج را در صورت نیاز با معادل دقیق فارسی و نام Latin داخل پرانتز بیاور. key_quote فقط نقل‌قول لفظ‌به‌لفظ کوتاه از متن ورودی باشد و در غیر این صورت خالی. summary باید 3 تا 5 جمله کامل و اطلاعات مهم منبع را حفظ کند و تا حد ممکن جزئیات فنی، شواهد، اعداد، روش یا محدودیت‌های موجود در منبع را فشرده اما معنادار منتقل کند؛ هر جمله باید یک اطلاعات مشخص داشته باشد و از کلی‌گویی پرهیز شود. why_it_matters باید 3 تا 4 جمله کامل و معمولاً 320 تا 500 نویسه باشد و مشخصاً پیامد، کاربرد، محدودیت یا اهمیت واقعی خبر را فقط بر پایه شواهد منبع توضیح دهد؛ why_it_matters نباید صرفاً summary را با واژه‌های دیگر تکرار کند. حدس یا ادعای جدید ممنوع؛ کوتاه‌نویسی یک‌جمله‌ای ممنوع مگر منبع واقعاً کوتاه باشد. قبل از تولید JSON، متن را از نظر روانی فارسی، انسجام جمله‌ها و تفاوت واقعی summary و why_it_matters بازبینی کن.
